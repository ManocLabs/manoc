...
has 'row_messages' => (
    is      => 'rw',
    isa     => 'ArrayRef[Manoc::Form::CSVImport::RowImportInfo]',
    traits  => ['Array'],
    default => sub { [] },
    handles => {
    ...
    foreach my $csv_row (@$csv_rows) {
        ...
        try {
            ...
            $self->add_row_message(
                Manoc::Form::CSVImport::RowImportInfo->new(
                    status      => 'success',
...
{
    package Manoc::Form::CSVImport::RowImportInfo;
