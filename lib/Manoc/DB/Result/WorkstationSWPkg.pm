...
package Manoc::DB::Result::WorkstationSWPkg;
...
__PACKAGE__->belongs_to(
    workstation => 'Manoc::DB::Result::Workstation',
    'workstation_id'
);

__PACKAGE__->belongs_to(
    software_pkg => 'Manoc::DB::Result::SoftwarePkg',
    'software_pkg_id'
);

=head1 NAME

Manoc::DB::Result::WorkstationSWPkg - A model object representing the JOIN
