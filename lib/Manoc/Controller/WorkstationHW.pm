...
package Manoc::Controller::WorkstationHW;
use Moose;
use namespace::autoclean;

BEGIN { extends 'Catalyst::Controller'; }
with
    "Manoc::ControllerRole::CommonCRUD",
    "Manoc::ControllerRole::JQDatatable",
    "Manoc::ControllerRole::JSONView",
    "Manoc::ControllerRole::CSVView";

use Manoc::Form::WorkstationHW;
use Manoc::Form::CSVImport::WorkstationHW;

=head1 NAME

Manoc::Controller::WorkstationHW - Catalyst Controller
...
__PACKAGE__->config(
    ...
    form_class              => 'Manoc::Form::WorkstationHW',
