package App::Manoc::DB::Search::Query;
...
my @QUERY_TYPES = qw(inventory building rack device server logon subnet ipaddr macaddr note );

enum 'QueryType' => \@QUERY_TYPES;
