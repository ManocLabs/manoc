...
like( $mech->find_link(  text =>'Add' )->url, qr|/workstation/create$|, "Add link points to create");
...
is($schema->resultset('Workstation')->find( { hostname => 'WORKSTATION001' } ), undef,  "workstation is deleted");
