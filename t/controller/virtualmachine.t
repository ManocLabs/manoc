...
$mech->submit_form_ok(
    {
        ...
        fields  => {
            'form-virtualmachine.ram_memory' => '16000',
            'form-virtualmachine.vcpus'      => 1,
            'form-virtualmachine.name'       => 'VMtestNic',
...
$mech->title_is( 'Manoc - Virtual Machine VMtestNic', "VM page" );
$mech->text_contains("00:aa:bb:cc:dd:ff", "Virtual machine contains nic mac address");
$mech->text_contains("nic0", "Virtual machine contains autogenerated nic name");
