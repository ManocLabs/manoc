...
$mech->post_json_ok( "$API_PREFIX/building/$object_id", {notes => 'new note'}, "Modify a building" );
$json = $mech->json_ok();
cmp_ok( $json->{status}, 'eq',  'success', "Status is 'success'" ) ||  diag explain $json;
...
$mech->get_ok("$API_PREFIX/building/$object_id");
$json = $mech->json_ok();
cmp_ok( $json->{notes}, 'eq', 'new note' , "Building contains modified field" ) ||  diag explain $json;
