...
like( $mech->find_link(  text =>'Add' )->url, qr|/warehouse/create$|, "Add link points to create");
...
$mech->text_contains('Warehouse is not empty. Cannot be deleted.', 'Cannot delete warehouse with assets');
