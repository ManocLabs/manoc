...
BEGIN { use_ok 'App::Manoc::IPAddress::IPv4' }
{
    ...
    cmp_ok( $addr eq App::Manoc::IPAddress::IPv4->new('10.1.100.1'),
        '==', 1, "operator eq object" );
    cmp_ok( $addr gt '2.1.1.1', '==', 1, "operator lt string" );
    cmp_ok( $addr gt App::Manoc::IPAddress::IPv4->new('2.1.1.1'),
        '==', 1, "operator lt object" );
    cmp_ok( $addr lt '192.10.0.0', '==', 1, "operator lt string" );
    cmp_ok( $addr lt App::Manoc::IPAddress::IPv4->new('192.10.0.0'),
        '==', 1, "operator lt object" );
...
BEGIN { use_ok 'App::Manoc::IPAddress::IPv4Network' }
{
    ...
    ok(
        $net->contains_address(
            App::Manoc::IPAddress::IPv4->new('192.168.1.5'),
            '192.168.1.0/24 contains 192.168.1.5'
        )
    );
    ok(
        !$net->contains_address(
            App::Manoc::IPAddress::IPv4->new('192.168.0.5'),
